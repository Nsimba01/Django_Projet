...
class Ingredient(models.Model):
    ...
    nomIngredient=models.CharField(max_length=50, verbose_name='nom ingredient')
...
class Pizza(models.Model):
    ...
    nomPizza=models.CharField(max_length=50, verbose_name='nom pizza')
...
class Composition(models.Model):
    ...
    def __str__(self)->str:
        ...
        ing=self.ingredient
        piz=self.pizza
        return img.__str__() +'fait partie de la pizza'+ piz.__str__()+'(qauntité='+self.quantite+')'
